...
```html
<win-field name="switch" label="开关">
  <template #input>
...
```html
<win-field name="checkbox" label="复选框">
  <template #input>
    <win-checkbox v-model="checkbox" shape="square" />
  </template>
</win-field>
<win-field name="checkboxGroup" label="复选框组">
  <template #input>
    <win-checkbox-group v-model="checkboxGroup" direction="horizontal">
      <win-checkbox name="1" shape="square">复选框 1</win-checkbox>
      <win-checkbox name="2" shape="square">复选框 2</win-checkbox>
    </win-checkbox-group>
  </template>
</win-field>
```
...
```html
<win-field name="radio" label="单选框">
  <template #input>
...
```html
<win-field name="stepper" label="步进器">
  <template #input>
...
```html
<win-field name="slider" label="滑块">
  <template #input>
...
```html
<win-field name="uploader" label="文件上传">
  <template #input>
