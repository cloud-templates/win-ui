...
```html
<win-picker show-toolbar title="Title" :columns="columns" :default-index="2" />
```

### Multiple Columns

```html
<win-picker show-toolbar title="Title" :columns="columns" />
```
...
```html
<win-picker show-toolbar title="Title" :columns="columns" @change="onChange" />
```
...
```html
<win-picker show-toolbar title="Title" :columns="columns" :loading="loading" />
```
