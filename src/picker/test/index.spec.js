...
test('drag columns', () => {
  ...
  triggerDrag(wrapper.find('.win-picker-column'), 0, -100);
  wrapper.find('.win-picker-column ul').trigger('transitionend');
...
test('simulation finger swipe again before transitionend', () => {
  ...
  triggerDrag(wrapper.find('.win-picker-column'), 0, -5);
  triggerDrag(wrapper.find('.win-picker-column'), -5, -100);
  wrapper.find('.win-picker-column ul').trigger('transitionend');
  expect(wrapper.emitted('change')[0][1]).toEqual('1995');
});
...
test('click column item', () => {
  ...
  wrapper.findAll('.win-picker-column__item').at(3).trigger('click');
