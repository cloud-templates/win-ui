...
```html
<win-pagination v-model="currentPage" :total-items="24" :items-per-page="5" />
```
...
```html
<win-pagination v-model="currentPage" :page-count="12" mode="simple" />
```
