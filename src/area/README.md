...
```html
<win-area title="Title" :area-list="areaList" />
```
...
```html
<win-area title="Title" :area-list="areaList" value="110101" />
```
...
```html
<win-area title="Title" :area-list="areaList" :columns-num="2" />
```
...
All code of China: [Area.json](https://github.com/youzan/win-ui/blob/dev/src/area/demo/area-en.js)
