...
```html
<win-area title="标题" :area-list="areaList" />
```
...
```html
<win-area title="标题" :area-list="areaList" value="110101" />
```
...
```html
<win-area title="标题" :area-list="areaList" :columns-num="2" />
```
...
完整数据见 [Area.json](https://github.com/youzan/win-ui/blob/dev/src/area/demo/area.js)
