...
```js
import Vue from 'vue';
import { NumberKeyboard } from 'win-ui';
...
```html
<win-cell @touchstart.native.stop="show = true">
  Show Keyboard
</win-cell>
<win-number-keyboard
  :show="show"
...
```html
<win-cell plain type="primary" @touchstart.native.stop="show = true">
...
```html
<win-cell plain type="info" @touchstart.native.stop="show = true">
