<template>
  <demo-section>
    <win-cell is-link @touchstart.native.stop="keyboard = 'default'">
      {{ t('button1') }}
    </win-cell>
    <win-cell is-link @touchstart.native.stop="keyboard = 'custom'">
      {{ t('button2') }}
    </win-cell>
    <win-cell is-link @touchstart.native.stop="keyboard = 'extraKey'">
      {{ t('button3') }}
    </win-cell>
    <win-cell is-link @touchstart.native.stop="keyboard = 'title'">
      {{ t('button4') }}
    </win-cell>
    <win-cell is-link @touchstart.native.stop="keyboard = 'multiExtraKey'">
      {{ t('button5') }}
    </win-cell>
    <win-field
      readonly
