    ...
    <win-tabs>
      <win-tab :title="t('basicUsage')">
        <win-list
          ...
          @load="onLoad(0)"
        >
          <win-cell v-for="item in list[0].items" :key="item" :title="item" />
        </win-list>
      </win-tab>

      <win-tab :title="t('errorInfo')">
        <win-list
          ...
          @load="onLoad(1)"
        >
          <win-cell v-for="item in list[1].items" :key="item" :title="item" />
        </win-list>
      </win-tab>

      <win-tab :title="t('pullRefresh')">
        <win-pull-refresh v-model="list[2].refreshing" @refresh="onRefresh(2)">
          <win-list
            ...
            @load="onLoad(2)"
          >
            <win-cell v-for="item in list[2].items" :key="item" :title="item" />
          </win-list>
        </win-pull-refresh>
      </win-tab>
    </win-tabs>
