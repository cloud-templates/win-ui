...
```html
<win-search v-model="value" placeholder="Placeholder" />
```
...
```html
<win-search v-model="value" input-align="center" placeholder="Placeholder" />
```

### Disabled

```html
<win-search v-model="value" disabled placeholder="Placeholder" />
```
