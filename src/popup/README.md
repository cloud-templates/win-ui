...
```html
<win-cell is-link @click="showPopup">Show Popup</win-cell>
<win-popup v-model="show">Content</win-popup>
```
...
```html
<win-popup v-model="show" position="top" :style="{ height: '30%' }" />
```
...
```html
<win-popup v-model="show" round position="bottom" :style="{ height: '30%' }" />
```
...
```html
<!-- mount to body -->
<win-popup v-model="show" get-container="body" />

<!-- mount to #app -->
<win-popup v-model="show" get-container="#app" />

<!-- Specify the mount location by function -->
<win-popup v-model="show" :get-container="getContainer" />
```
