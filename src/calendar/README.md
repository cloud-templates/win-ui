...
```html
<win-cell title="Select Single Date" :value="date" @click="show = true" />
<win-calendar v-model="show" @confirm="onConfirm" />
```
...
```html
<win-cell title="Select Multiple Date" :value="text" @click="show = true" />
<win-calendar v-model="show" type="multiple" @confirm="onConfirm" />
```
...
```html
<win-cell title="Select Date Range" :value="date" @click="show = true" />
<win-calendar v-model="show" type="range" @confirm="onConfirm" />
```
...
```html
<win-calendar v-model="show" :show-confirm="false" />
```
...
```html
<win-calendar v-model="show" color="#07c160" />
```
...
```html
<win-calendar v-model="show" :min-date="minDate" :max-date="maxDate" />
```
...
```html
<win-calendar v-model="show" type="range" :formatter="formatter" />
```
...
```html
<win-calendar v-model="show" :round="false" position="right" />
```
...
```html
<win-calendar type="range" :max-range="3" :style="{ height: '500px' }" />
```
