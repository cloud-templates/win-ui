...
| iconPrefix `v2.0.9` | Icon className prefix | _string_ | `win-icon` |
...
| transition `v2.2.6` | Transition, equivalent to `name` prop of [transtion](https://vuejs.org/v2/api/#transition) | _string_ | `win-fade` |
