...
<win-swipe-cell>
  <template #left>
    <win-button square type="primary" text="Select" />
  </template>
  <win-cell :border="false" title="Cell" value="Cell Content" />
  <template #right>
    <win-button square type="danger" text="Delete" />
    <win-button square type="primary" text="Collect" />
  </template>
</win-swipe-cell>
```
...
<win-swipe-cell>
  ...
  />
  <template #right>
    <win-button square text="Delete" type="danger" class="delete-button" />
  </template>
</win-swipe-cell>
