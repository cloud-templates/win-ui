  ...
  <demo-section>
    ...
    <demo-block :title="t('basicUsage')">
      <div class="sku-container">
        ...
        />
        <win-button block type="primary" @click="showBase = true">
          {{ t('basicUsage') }}
        </win-button>
      </div>
    </demo-block>
    ...
    <demo-block :title="t('title2')">
      <div class="sku-container">
        <win-sku
          ...
          @add-cart="onAddCartClicked"
        />
        <win-button block type="primary" @click="showStepper = true">
          {{ t('title2') }}
        </win-button>
      </div>
    </demo-block>
    ...
    <demo-block :title="t('hideSoldoutSku')">
      <div class="sku-container">
        <win-sku
          ...
          @add-cart="onAddCartClicked"
        />
        <win-button block type="primary" @click="showSoldout = true">
          {{ t('hideSoldoutSku') }}
        </win-button>
      </div>
    </demo-block>
      ...
      <div class="sku-container">
        ...
        >
          <template #sku-header-price="{ price }">
            <div class="win-sku__goods-price">
              <span class="win-sku__price-symbol">￥</span>
              <span class="win-sku__price-num">{{ price }}</span>
            </div>
          </template>
          <template #sku-actions-top>
            <div class="win-sku-header-item text-center">
              {{ t('actionsTop') }}
            </div>
          </template>
          <template #sku-actions="{ skuEventBus }">
            <div class="win-sku-actions">
              <win-button
                square
                size="large"
                type="warning"
        ...
        <win-button block type="primary" @click="showCustom = true">
          {{ t('advancedUsage') }}
        </win-button>
      </div>
    </demo-block>
