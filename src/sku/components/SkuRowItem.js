    ...
    return (
      <span
        class={[
          'win-sku-row__item',
          {
            'win-sku-row__item--active': choosed,
            'win-sku-row__item--disabled': !this.choosable,
          },
        ]}
        onClick={this.onSelect}
      >
        {imgUrl && <img class="win-sku-row__item-img" src={imgUrl} />}
        <span class="win-sku-row__item-name">{this.skuValue.name}</span>
      </span>
    );
  },
});
