...
export default createComponent({
  ...
  computed: {
    skuGroupClass() {
      return [
        'win-sku-group-container',
        {
          'win-sku-group-container--hide-soldout': !this.showSoldoutSku,
        },
      ];
    },
  ...
  render() {
      ...
      >
        ...
        {slots('sku-header-price') || (
          <div class="win-sku__goods-price">
            ...
            {this.priceTag && (
              <span class="win-sku__price-tag">{this.priceTag}</span>
            )}
          </div>
        )}
        ...
        {!this.hideStock && (
          <SkuHeaderItem>
            <span class="win-sku__stock">{this.stockText}</span>
          </SkuHeaderItem>
        )}
    ...
    return (
      <Popup
        ...
        closeable
        position="bottom"
        class="win-sku-container"
        getContainer={this.getContainer}
        closeOnClickOverlay={this.closeOnClickOverlay}
        safeAreaInsetBottom={this.safeAreaInsetBottom}
      >
        {Header}
        <div class="win-sku-body" style={this.bodyStyle}>
          {slots('sku-body-top')}
          {Group}
