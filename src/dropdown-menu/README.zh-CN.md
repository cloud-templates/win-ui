...
<win-dropdown-menu>
  ...
  <win-dropdown-item title="筛选" ref="item">
    <win-switch-cell v-model="switch1" title="包邮" />
    <win-switch-cell v-model="switch2" title="团购" />
    <win-button block type="info" @click="onConfirm">确认</win-button>
  </win-dropdown-item>
</win-dropdown-menu>
```
