...
```html
<win-rate v-model="value" icon="like" void-icon="like-o" />
```
...
```html
<win-rate v-model="value" allow-half void-icon="star" void-color="#eee" />
```
...
```html
<win-rate v-model="value" :count="6" />
```

### 禁用状态

```html
<win-rate v-model="value" disabled />
```

### 只读状态

```html
<win-rate v-model="value" readonly />
```

### 监听 change 事件

```html
<win-rate v-model="value" @change="onChange" />
```
