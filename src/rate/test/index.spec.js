...
test('change event', () => {
  ...
  const item4 = wrapper.findAll('.win-rate__icon').at(3);
...
test('allow half', () => {
  ...
  const item4 = wrapper.findAll('.win-rate__icon--half').at(3);
...
test('disabled', () => {
  ...
  const item4 = wrapper.findAll('.win-rate__item').at(3);
...
test('touchmove to select item', () => {
  ...
  const icons = wrapper.findAll('.win-rate__item');
