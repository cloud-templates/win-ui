<template>
  <demo-section>
    <demo-block :title="t('basicUsage')">
      <win-cell is-link :title="t('basicUsage')" @click="show.basic = true" />
      <win-cell is-link :title="t('showCancel')" @click="show.cancel = true" />
      <win-cell
        is-link
    ...
    <demo-block :title="t('customPanel')">
      <win-cell is-link :title="t('customPanel')" @click="show.title = true" />
    </demo-block>
    ...
    <win-action-sheet v-model="show.title" :title="t('title')">
