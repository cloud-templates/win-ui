<template>
  <demo-section>
    ...
    <demo-block :title="t('customFormat')">
      <win-count-down :time="time" :format="t('formatWithDay')" />
    </demo-block>
    ...
    <demo-block :title="t('manualControl')">
      ...
      <win-grid clickable :column-num="3">
        <win-grid-item icon="play-circle-o" :text="t('start')" @click="start" />
        <win-grid-item
          icon="pause-circle-o"
          :text="t('pause')"
          @click="pause"
        />
        <win-grid-item icon="replay" :text="t('reset')" @click="reset" />
      </win-grid>
    </demo-block>
  </demo-section>
</template>
